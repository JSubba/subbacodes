  ...
  return (
    ...
    >
      <div className="max-w-[55rem] mx-auto px-10 -m-8 flex flex-col justify-center h-full">
        ...
        <p className="py-4 text-1xl max-w-md">
        ...
        <div>
          <Link to="projects" smooth={true} duration={500}>
            <button className="px-10 py-6 my-2 text-1xl flex items-center shadow-md shadow-cyan-500 hover:text-cyan-500 hover:scale-105 ease-in duration-500 font-semibold">
              View Projects
              <span>
