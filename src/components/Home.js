  ...
  return (
    ...
    >
      <div className="max-w-[55rem] mx-auto px-8 -m-8 flex flex-col justify-center h-full">
        <h1 className="text-8xl text-cyan-500 sm:text-6xl font-bold">
          J.Subba
        </h1>
        <h2 className="text-10xl sm:text-8xl font-bold py-4">
          I'm a Web Developer
        </h2>
        ...
        <div>
          <Link to="projects" smooth={true} duration={500}>
            <button className="px-10 py-6 my-2 flex items-center shadow-md shadow-cyan-500 hover:text-cyan-500 hover:scale-105 ease-in duration-500 font-semibold">
              View Projects
              <span>
